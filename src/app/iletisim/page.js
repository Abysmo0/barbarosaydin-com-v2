...
export default function ContactPage() {
  ...
  return (
    <>
      <section className="bg-white pt-20 pb-12">
        <div className="container mx-auto px-6">
          <div className="max-w-5xl mx-auto text-center mb-12">
            <h1 className="text-5xl md:text-4xl font-bold text-gray-900">İletişime Geçin</h1>
            <p className="text-lg text-gray-600 mt-4">Aşağıdaki formu doldurarak veya diğer kanallardan bana ulaşabilirsiniz.</p>
          </div>
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-12 items-start">
            <div className="bg-gray-50 p-8 rounded-lg border border-gray-200 md:col-span-3">
              <form onSubmit={handleSubmit}>
                 {/* ... form içeriği aynı ... */}
                 <div className="mb-5">
                  <label htmlFor="name" className="block text-gray-700 font-bold mb-2">Adınız Soyadınız</label>
                ...
                <div className="mb-5">
                  <label htmlFor="email" className="block text-gray-700 font-bold mb-2">E-posta Adresiniz</label>
                ...
                <div className="mb-5">
                  <label htmlFor="subject" className="block text-gray-700 font-bold mb-2">Konu</label>
                ...
                <div className="mb-5">
                  <label htmlFor="message" className="block text-gray-700 font-bold mb-2">Mesajınız</label>
                ...
                {status === 'success' && <p className="text-green-600 mt-4 text-center">Mesajınız başarıyla gönderildi!</p>}
                {status === 'error' && <p className="text-red-600 mt-4 text-center">Bir hata oluştu. Lütfen daha sonra tekrar deneyin.</p>}
              </form>
            </div>
            ...
            <div className="space-y-8 md:col-span-2">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <a href="https://calendly.com/barbarosaydin" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:underline">
                    Online toplantı planlayın
                  </a>
                </div>
              </div>
              <div className="flex items-center">
                <div className="flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-lg bg-gray-100 text-gray-600 group hover:text-fenerbahce-navy transition-colors">
                  <IconMail />
                </div>
                <div className="ml-4">
              ...
              <div className="flex items-center">
                <div className="flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-lg bg-gray-100 text-gray-600 group hover:text-green-500 transition-colors">
                  <IconWhatsApp />
                </div>
                <div className="ml-4">
              ...
              <div className="flex items-center">
                <div className="flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-lg bg-gray-100 text-gray-600 group hover:text-red-500 transition-colors">
                  <IconLocation />
                </div>
                <div className="ml-4">
      ...
      {/* Sizin sağladığınız doğru harita kodu */}
      <section>
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2481.1914732077475!2d-0.08929842311917445!3d51.54638790785389!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x48761c9b32639327%3A0x6777dea041ec9228!2sWorkspace%C2%AE%20%7C%20Leroy%20House!5e0!3m2!1str!2suk!4v1755456480703!5m2!1str!2suk"
          width="100%"
          height="450"
